...
public class PersistenciaPoiTest {
	...
	@Test
	public void testHerenciaRoles() {

		SessionFactory sessionFactory = ConexionDB.getSessionFactory();
		...
		RolTerminal rolTermi = new RolTerminal();
		rolTermi.setNombre("TerminaAbasto");
	...
	// recuperarlo y
	// verificar que las coordenadas sean las ingresadas en la última
	// modificación.
	@Test
	public void modificarPoiTest() {
		...
		System.out.println("Latitud Mod"
				+ poiObtenido.getLocacion().getCoordenada().getLatitud()
				+ " Longitud Mod"
				+ poiObtenido.getLocacion().getCoordenada().getLongitud());
		...
		System.out.println("Latitud Mod"
				+ poiModificado.getLocacion().getCoordenada().getLatitud()
				+ " Longitud Mod"
				+ poiModificado.getLocacion().getCoordenada().getLongitud());
		...
		// bancoModificado =
		// tipoModificado.obtenerPOI(tipoModificado.getIdTipoPoi());
		//
		// System.out.println("Servicio 2 "+((SucursalBanco)
		// bancoModificado).getServicios().get(1));
	...
	public void crearCGPTest() throws Exception {
		...
		// ResultadoBusquedaParcial miResultado = new
		// ResultadoBusquedaParcial();
		//
		// miResultado.setCriterioBusqueda("Banco");
		// miResultado.setFecha(LocalDateTime.now());
		// miResultado.setCantidadResultados(3);
		//
		// ResultadoBusquedaParcialUsuario miResultadoUsuario = new
		// ResultadoBusquedaParcialUsuario();
		// miResultadoUsuario.setUsuario("Guille");
		//
		// List<ResultadoBusquedaParcial> resultados = new
		// ArrayList<ResultadoBusquedaParcial>();
		//
		// POI poi1=new POI();
		// poi1.setNombre("POI1");
